...
- [x] 6.4 Open the PR for this change. Once merged, cut release `v0.3.0` (BREAKING — adopters MUST migrate per SETUP.md).
- [x] 6.5 Archive this change via `openspec archive pr-author-github-app`.
